...
class Validator:
    ...
    @classmethod
    def bert_validate(cls, df, tokenizer, n_runs=3, random_seeds=None):
        """
        ...
        for run_idx, seed in enumerate(random_seeds):
            ...
            # Include SLURM job IDs if running inside SLURM for parallel safety
        ...
        # Return values
        return median_trainer, median_report, median_cm, all_results
